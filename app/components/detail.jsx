...
import Evi from 'public/images/evidence.jpg'
    ...
    <>
      <div className='bg-black h-96 mt-10 mx-10'>
        ...
        <div className='my-20 text-center'>
              <p className='text-gray-500 text-3xl'>meet the ceo</p>
        ...
        <h2 className=' text-center text-3xl pt-20'> At Consult Omj we’re a group of creative thinkers <br /> who have built a business to change the world.</h2>
          

        <div className=' mx-7 md:mx-44 mt-24 text-center py-16'>
           ...
           <Image alt='Evi' src={Evi} width={300} height={400} className=' mx-8 md:mx-auto ' />
        <div className=' mx-7 md:mx-44 mt-24 text-center py-16'>

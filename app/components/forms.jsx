...
export default function Forms() {
  return (
        ...
        <div className='border-2 text-center mt-16 mx-16  '>
            <form action="https://formsubmit.co/ayodeleomojolag@gmail.com" method="POST" >
                ...
                <textarea placeholder="Message....." class="form-control p-10 border rounded-lg" name="message" className='border-2 h-16 w-1/2 p-4 mb-2' />
              <br />
